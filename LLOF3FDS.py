...
def make_LLO(LLO):
    ...
    LLO.sSRM_FI.L = L_srmar_iba + L_iba_ofi + L_ip + L_rot + L_op #(=0.8684908776146442m) -include L_op here? check.
    # ---------
    ...
    # beam parameter - VOPO parameter from Maggie's email to Carl
    # LLO.sqz.q = BeamParam(w0=0.217e-3, z=-0.054)

    # # VOPOM1 --Missing: thickness, material, reflectivities.
    # LLO.M1_OPO.alpha = 0
    # LLO.subM1_OPO.L = 0
    # LLO.subM1_OPO.n = 1
    # LLO.M1_OPO_AR.alpha = 0
    # LLO.lM1_OPO_EDGE.L = 0

    # # OPOL1
    # # kat.lsqz_lens1.L = 0.345 #Maggies email to Carl, pre-MMstudy
    # LLO.lsqz_lens1.L = 0.2393  # as of Dec 7th 2018, directly measured
    # # L1ROC = 0.050 #from Carl, pre-MMstudy
    # L1ROC = 200e-3  # as of Dec 7th 2018
    # LLO.sqz_lens1.f = ((1.45-1)*(1/L1ROC))**-1

    # # SQZ faraday
    # LLO.lsqz_faraday.L = 0.02
    # LLO.lsqz_faraday.n = 1.944  # TGG, email betweek EOT and Dan Brown April 2018

    # # OPOL2
    # # kat.lsqz_faraday_lens2.L = 0.878-0.345 #Maggies email to Carl, pre-MMstudy
    # LLO.lsqz_faraday_lens2.L = 0.5642  # as of Dec 7th 2018, directly measured
    # # L2ROC = 0.150 #from Carl, pre-MMstudy
    # L2ROC = 350e-3  # as of Dec 7th 2018
    # LLO.sqz_lens2.f = ((1.45-1)*(1/L2ROC))**-1
    # # [Crl:]Its OPOL2 thats on the translation stage with 32mm travel
    # # kat.data['L2range'] = 0.032

    # # ZM1
    # #ZM1_to_OPOM2 = 0.13951
    # #OPOM2_to_OPOL2 = 0.19537
    # # kat.lsqz_lens2_zm1.L = OPOM2_to_OPOL2 + ZM1_to_OPOM2 #from Carl, pre-MMstudy
    # LLO.lsqz_lens2_zm1.L = 0.2348  # as of Dec 7th 2018, directly measured

    # # ZM2
    # LLO.lzm1_zm2.L = 2.21668  # zemax

    # # to OFI #zemax
    # #OFIback_to_Polar = 0.23761
    # #Polar_to_OFIM2 = 0.11633
    # #OFIm2_to_M1 = 0.11154
    # #OFIM1_to_ZM2 = 0.97174
    # # kat.lzm2_OFI.L = OFIback_to_Polar + Polar_to_OFIM2 + OFIm2_to_M1 + OFIM1_to_ZM2 #from Carl/zemax Nov 2018
    # LLO.lzm2_OFI.L = 1.19962  # zema
